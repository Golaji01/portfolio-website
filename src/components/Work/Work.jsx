    ...
    >
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 p-4">
          <div className="bg-gray-900 rounded-xl shadow-2xl w-full max-w-3xl h-[90vh] overflow-y-auto relative">
            {/* Close Button */}
            <button
            ...
            <div className="flex flex-col items-center px-6 py-4">
              <img
                ...
                className="w-full max-h-96 object-contain rounded-xl shadow-2xl mb-6"
              />
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 w-full">
                {selectedProject.github && (
                  <a
                    ...
                    className="flex-1 bg-gray-800 hover:bg-purple-800 text-gray-300 px-4 py-2 rounded-xl text-sm font-semibold text-center"
                  >
                    View Code
                  </a>
                )}
